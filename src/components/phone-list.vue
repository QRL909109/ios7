<template>
    <div ref="phoneListScroll" class="phone-wrapper">
        <ul>
            <li v-for="(item,index) in personList" class="personal_list">
            ...
            <div class="handle">
                <div class="handle-del red_bg" @click.capture="del_personal(item.id)" onclick="">
                    删除
                </div>
            </div>
        </li>
...
<script type="text/ecmascript-6">
    ...
    export default {
       ...
       /* computed: {
        ...
        methods: {
            _initScroll(){
                this.containerScroll = new BScroll(this.$refs.phoneListScroll,{
                    click:true
                });
            },
            del_phone(index){
